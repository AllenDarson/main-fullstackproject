                  ...
                  <div class="row content-home2">
                      <div class="col-lg-7 col-md-5">
                          <div class="box-container">
                              <img src="./carefree-1299639_1920.png" class="img-home" alt="banner img">
                          </div>
                      </div>
                      <div class="col-lg-5 col-md-7">
                          <div class="box-container2">
                              <h1 class="home-heading"><span class="home-span">Zumba Dance Training</span></h1>
                              </div>
                      </div>    
                  </div>
              </div>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="content-about" style="background-color: transparent;">
                                <h2 class="heading-about">Zumba Dance Training</h2>
                                <p >
                                    Zumba dance training is a high-energy fitness program that combines Latin and international music with dance moves. It creates a dynamic, fun workout that is both effective and enjoyable. Zumba routines incorporate interval training, alternating fast and slow rhythms to improve cardiovascular fitness, burn calories, and enhance overall endurance. Suitable for all fitness levels, Zumba helps improve coordination, flexibility, and muscle tone while promoting a sense of community and social interaction. The dance-based exercise is also known to boost mood and reduce stress, making it a holistic approach to achieving physical and mental well-being.
                                    </p> 
                                <h2 class="heading-about">Benifits</h2>
                                <p >
                                    1.Cardiovascular Health:Increases heart rate and improves cardiovascular endurance.Effective for maintaining a healthy heart and reducing cardiovascular disease risk.
                                    <br>
                                    2.Calorie Burn:High-energy dance routines can burn between 500-1000 calories per hour.Supports weight loss and helps maintain a healthy weight.
                                    <br>
                                    3.Full-Body Workout:Engages multiple muscle groups, including legs, core, and arms.Enhances muscle tone, strength, and flexibility.
                                    <br>
                                    4.Mental Health:The fun and energetic nature of Zumba boosts mood and reduces stress.Releases endorphins, contributing to overall mental well-being.
                                     <br>
                                    5.Social Interaction:Group classes foster a sense of community and camaraderie.Encourages social interaction and motivation.
                                    </p>
                                <h2 class="heading-about">Class Structure</h2>    
                               <p> 1.Warm-ups:Gentle movements to prepare the body for exercise.Gradually increases heart rate and loosens muscles.
                                <br>
                                2.Main Workout:Alternates between fast and slow rhythms.Incorporates various dance styles and fitness moves.
                                <br>
                                3.Cool-Down:Slow, relaxing movements to lower the heart rate.Includes stretching to enhance flexibility and reduce muscle soreness.
                                <br>
                            </p>

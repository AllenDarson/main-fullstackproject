              ...
              <div class="row content-home2">
                  <div class="col-lg-7 col-md-5">
                      <div class="box-container">
                          <img src="./bodybuilder-4743091_1920.png" class="img-home" alt="banner img">
                      </div>
                  </div>
                  <div class="col-lg-5 col-md-7">
                      <div class="box-container2">
                          <h1 class="home-heading"><span class="home-span">Body Building</span></h1>
                          </div>
                  </div>    
              </div>
          </div>
              ...
              <div class="row">
                  <div class="col-lg-12">
                      <div class="content-about" style="background-color: transparent;">
                          <h2 class="heading-about">BodyBuilding</h2>
                          <p >
                             Calisthenics is a form of exercise that uses body weight for resistance training. It focuses on movements such as push-ups, pull-ups, squats, and planks to build strength, flexibility, and endurance. Calisthenics workouts can be performed anywhere without the need for equipment, making them accessible and versatile. This form of exercise improves overall fitness by targeting multiple muscle groups simultaneously, promoting functional strength and agility. Calisthenics routines can be tailored to suit different fitness levels, from beginners to advanced athletes, by adjusting intensity and variations of exercises. It emphasizes body control, balance, and core stability, making it a popular choice for those seeking a holistic approach to fitness and strength training.
                              ...
                              <p >
                                Bodybuilding is a disciplined approach to developing and sculpting muscle mass through progressive resistance training, nutrition, and supplementation. It focuses on achieving hypertrophy (muscle growth) through targeted exercises that stress specific muscle groups. Key principles include lifting progressively heavier weights, consuming a high-protein diet to support muscle repair and growth, and maintaining a balanced intake of carbohydrates and fats for energy and recovery. Bodybuilders often follow structured workout routines that prioritize different muscle groups on different days. The sport also emphasizes symmetry, proportion, and definition, achieved through careful attention to training techniques, rest periods, and overall lifestyle choices.
                            </p> 
                            <h2 class="heading-about">Key Components</h2>
                            <p >
                                1.Resistance Training:Central to bodybuilding, focusing on lifting weights to stimulate muscle growth.Includes exercises like squats, bench press, deadlifts, and isolation movements.Progressive overload principle: gradually increasing weight or resistance.
                                <br>
                                2.Nutrition:Essential for muscle growth and recovery.High-protein diet to support muscle repair and growth.Balanced intake of carbohydrates and healthy fats for energy and overall health.Importance of calorie surplus for bulking and calorie deficit for cutting.
                                <br>
                                3.Rest and Recovery:Muscles grow during rest, not during workouts.Adequate sleep (7-9 hours per night) is crucial.Incorporate rest days and recovery techniques like stretching and foam rolling.
                                <br>
                                </p>
                                <h2 class="heading-about">Training Phases</h2> 
                            <p >
                                1.Bulking Phase:Aim to gain muscle mass by consuming a calorie surplus.Focus on heavy lifting and compound movements.Accept some fat gain as part of the process.
                                <br>
                                2.Cutting Phase:Aim to reduce body fat while preserving muscle mass.Maintain a calorie deficit through diet and cardio.Focus on higher reps and maintaining strength.
                                <br>
                                3.Maintenance Phase:Maintain muscle mass and low body fat.Balanced diet and consistent training.Prevent excessive fat gain or muscle loss.
                                <br>
                                 </p>
                      </div>
                  </div>
